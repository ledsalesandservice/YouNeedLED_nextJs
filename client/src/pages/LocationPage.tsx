      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            name: "You Need L.E.D.",
            description: `Professional security and technology services in ${location.name}${!isRegion ? `, ${location.state}` : ""}. NJ DCA Licensed. 15+ years experience. 5.0 stars on Google.`,
