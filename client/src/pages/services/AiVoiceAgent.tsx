        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "What is LEDConnect and who is it for?", a: "LEDConnect is You Need L.E.D.'s proprietary AI Voice Agent platform built for small and mid-size businesses in South Jersey. It answers every inbound call 24/7, blocks spam, captures lead information, books appointments, and integrates with your VoIP phone system — so you never miss a business opportunity again." },
              { q: "What areas do you serve for AI Voice Agent and VoIP services?", a: "We serve businesses throughout South Jersey and the Delaware Valley from our Linwood, NJ office — including Atlantic City, Egg Harbor Township, Somers Point, Cherry Hill, Voorhees, Mount Laurel, Vineland, Cape May County, Camden County, Burlington County, and the greater Philadelphia area." },
              { q: "How much does the LEDConnect AI Voice Agent cost?", a: "LEDConnect pricing is based on call volume and the features you need. It is offered as a monthly subscription with no long-term contract required. Contact us at (609) 335-0123 for a personalized demo and pricing quote." },
            ].map((faq, i) => (
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              mainEntity: [
                ...
                { "@type": "Question", name: "What is LEDConnect and who is it for?", acceptedAnswer: { "@type": "Answer", text: "LEDConnect is You Need L.E.D.'s proprietary AI Voice Agent platform built for small and mid-size businesses in South Jersey. It answers every inbound call 24/7, blocks spam, captures lead information, books appointments, and integrates with your VoIP phone system \u2014 so you never miss a business opportunity again." } },
                { "@type": "Question", name: "What areas do you serve for AI Voice Agent and VoIP services?", acceptedAnswer: { "@type": "Answer", text: "We serve businesses throughout South Jersey and the Delaware Valley from our Linwood, NJ office \u2014 including Atlantic City, Egg Harbor Township, Somers Point, Cherry Hill, Voorhees, Mount Laurel, Vineland, Cape May County, Camden County, Burlington County, and the greater Philadelphia area." } },
                { "@type": "Question", name: "How much does the LEDConnect AI Voice Agent cost?", acceptedAnswer: { "@type": "Answer", text: "LEDConnect pricing is based on call volume and the features you need. It is offered as a monthly subscription with no long-term contract required. Contact us at (609) 335-0123 for a personalized demo and pricing quote." } },
              ],
            }),
          }}
        />
