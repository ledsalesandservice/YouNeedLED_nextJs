...
export default function JobsiteSecurity() {
  return (
    ...
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      "@type": "Service",
      name: "Jobsite & Construction Site Security Camera Installation",
      description: "Solar-powered wireless security cameras for construction sites and temporary locations in South Jersey. No power or internet required. Includes cellular connectivity, remote monitoring, and theft deterrence.",
      provider: { "@type": "LocalBusiness", name: SITE.name, url: SITE.url, telephone: SITE.phone },
      areaServed: ["South Jersey", "Atlantic County NJ", "Cape May County NJ", "Camden County NJ", "Delaware Valley"],
      serviceType: "Jobsite Security Camera Installation",
      url: `${SITE.url}/services/jobsite-security`,
    }) }} />
    <ServicePageLayout
      ...
      faqs={[
        ...
        { q: "What areas of South Jersey do you serve for jobsite security?", a: "We serve construction sites, development projects, and commercial properties throughout South Jersey and the Delaware Valley — including Atlantic, Cape May, Camden, Burlington, Gloucester, Ocean, and Cumberland counties. We also cover Philadelphia and Delaware job sites." },
        { q: "Are you licensed to provide security camera services in New Jersey?", a: "Yes. You Need L.E.D. is NJ DCA Licensed (#34BF00056900), fully bonded and insured. We have been protecting South Jersey job sites since 2010. Owner Derek Weikel brings 34 years of industry experience in commercial security technology." },
        { q: "How quickly can you deploy cameras to a new job site?", a: "In most cases we can have solar-powered cameras deployed and live at your job site within 24–48 hours of your call. Equipment is pre-configured and ready to go. Call (609) 335-0123 to get your site protected fast." },
      ]}
      relatedServices={[
