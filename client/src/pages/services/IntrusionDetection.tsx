  ...
  return (
    ...
    <ServicePageLayout
      ...
      faqs={[
        ...
        { q: "Are you licensed to install alarm systems in New Jersey?", a: "Yes. You Need L.E.D. holds NJ DCA Security License #34BF00056900. We are fully licensed, bonded, and insured for commercial and residential intrusion detection installation throughout New Jersey. All systems are installed to NJ state code." },
        { q: "What areas of South Jersey do you serve for alarm systems?", a: "We serve all of South Jersey and the Delaware Valley from our Linwood, NJ office — including Atlantic City, Egg Harbor Township, Somers Point, Galloway, Cherry Hill, Voorhees, Mount Laurel, Vineland, Cape May County, Camden County, and Burlington County." },
        { q: "How much does a commercial alarm system cost?", a: "Commercial intrusion detection systems typically start at $1,499 for small businesses. Mid-size commercial properties with multiple zones run $2,499–$4,999. Large facilities and multi-site systems are custom quoted. Monthly monitoring starts at $39.99. Call (609) 335-0123 for a free on-site assessment." },
        { q: "Do you offer 24/7 professional alarm monitoring?", a: "Yes. All our alarm systems include optional 24/7 COPS Monitoring — a UL-listed central station that verifies alarms using live video before dispatching police. This dramatically reduces false alarms and ensures fast response when it matters." },
      ]}
      relatedServices={[
