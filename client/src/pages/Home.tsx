...
import {
  ...
  Camera, KeyRound, Flame, ShieldAlert, HardHat, Monitor, Cable,
...
const iconMap: Record<string, React.ReactNode> = {
  ...
  HardHat: <Shield className="w-6 h-6" />,
          ...
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-slate-500">33+ verified Google reviews</p>
              </div>
          ...
          __html: JSON.stringify([
            {
              ...
              sameAs: [
                ...
                "https://www.linkedin.com/company/you-need-led",
                "https://maps.app.goo.gl/youneedled",
                "https://www.homeadvisor.com/rated.YouNeedLED.html",
                "https://www.bbb.org/us/nj/egg-harbor-township/profile/security-systems/you-need-led-0221-90060282",
              ],
              priceRange: "$$",
              ...
              hasOfferCatalog: {
                ...
                itemListElement: [
                  { "@type": "Offer", itemOffered: { "@type": "Service", "@id": `${SITE.url}/services/video-surveillance#service`, name: "Commercial Security Camera Systems", description: "4K AI-powered security camera installation with cloud storage, license plate recognition, and 24/7 remote monitoring for businesses and residences in South Jersey.", url: `${SITE.url}/services/video-surveillance`, provider: { "@id": `${SITE.url}/#organization` } } },
                  { "@type": "Offer", itemOffered: { "@type": "Service", "@id": `${SITE.url}/services/fire-alarm#service`, name: "Fire Alarm System Installation", description: "NFPA 72 compliant fire alarm installation, inspection, and 24/7 monitoring for commercial and residential properties in New Jersey.", url: `${SITE.url}/services/fire-alarm`, provider: { "@id": `${SITE.url}/#organization` } } },
                  { "@type": "Offer", itemOffered: { "@type": "Service", "@id": `${SITE.url}/services/access-control#service`, name: "Access Control Systems", description: "Keyless entry, cloud-managed door access, and credential management systems for commercial buildings and multi-tenant properties.", url: `${SITE.url}/services/access-control`, provider: { "@id": `${SITE.url}/#organization` } } },
                  { "@type": "Offer", itemOffered: { "@type": "Service", "@id": `${SITE.url}/services/voip#service`, name: "Hosted VoIP Phone Systems", description: "Cloud-based business phone systems with unlimited calling, auto-attendant, voicemail-to-email, and mobile app for South Jersey businesses.", url: `${SITE.url}/services/voip`, provider: { "@id": `${SITE.url}/#organization` } } },
                  { "@type": "Offer", itemOffered: { "@type": "Service", "@id": `${SITE.url}/services/ai-voice-agent#service`, name: "LEDConnect AI Voice Agent", description: "AI-powered virtual receptionist that answers calls 24/7, blocks spam, captures leads, and schedules appointments for South Jersey businesses.", url: `${SITE.url}/services/ai-voice-agent`, provider: { "@id": `${SITE.url}/#organization` } } },
            ...
            },
            {
              ...
              "@type": "Organization",
              "@id": `${SITE.url}/#corp`,
              name: "You Need L.E.D. L.L.C.",
              legalName: "You Need L.E.D. L.L.C.",
              alternateName: ["You Need LED", "YouNeedLED", "YNL"],
              url: SITE.url,
              logo: {
                "@type": "ImageObject",
