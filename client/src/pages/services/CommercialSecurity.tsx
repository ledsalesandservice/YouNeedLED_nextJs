    ...
    <>
      ...
      <section className="relative py-20 lg:py-28 bg-[#0e319a]">
        <div className="absolute inset-0 opacity-20">
          <img src={IMAGES.heroMain} srcSet={IMAGE_SRCSETS.heroMain} sizes="100vw" alt="Commercial security camera and access control installation in South Jersey" className="w-full h-full object-cover max-w-full" loading="eager" fetchPriority="high" width="1920" height="1072" />
        </div>
