    ...
    <>
      ...
      <section className="relative py-20 lg:py-28 bg-[#0e319a]">
        <div className="absolute inset-0 opacity-15">
          <img src={IMAGES.heroMain} srcSet={IMAGE_SRCSETS.heroMain} sizes="100vw" alt="You Need L.E.D. security and technology team serving South Jersey since 2010" className="w-full h-full object-cover max-w-full" loading="eager" fetchPriority="high" width="1920" height="1072" />
        </div>
